...
# Read the datasets
airbnb     <- read_csv("/Users/harshjasrapuria/Desktop/mysite/blog/project4/airbnb.csv")
blueprinty <- read_csv("/Users/harshjasrapuria/Desktop/mysite/blog/project4/blueprinty.csv")
```
...
poisson_loglikelihood <- function(lambda, Y) {
  if (lambda <= 0) return(-Inf)  # Ensure λ > 0
